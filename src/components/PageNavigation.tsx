...
const navLinks = [
  { label: 'Accueil', href: '/' },
  { label: 'Résidentiel', href: '/services/residentiel' },
    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <a href="tel:5145550142">
                <Button
                  className="bg-copper hover:bg-copper/90 text-white font-semibold px-5 py-2.5 rounded-xl shadow-lg shadow-copper/25 transition-all hover:shadow-xl hover:shadow-copper/30 hover:-translate-y-0.5"
                >
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-8 pt-20">
          ...
          <a href="tel:5145550142">
            <Button
              className="bg-copper hover:bg-copper/90 text-white font-semibold px-8 py-3 rounded-xl mt-4"
            >
              <Phone className="w-4 h-4 mr-2" />
              Urgence 24/7
            </Button>
